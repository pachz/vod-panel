...
const translations = {
  en: {
    ...
    "personalTestsPaywallTitle": "Unlock personal tests",
    "personalTestsPaywallPremiumLabel": "Personal tests",
    "personalTestsPaywallSubscribeDescription": "Choose a plan that includes personal tests to take assessments and get personalized program recommendations.",
    "personalTestsPaywallUpgradeDescription": "Your current plan does not include personal tests. Upgrade to a plan that does.",
    "personalTestsPaywallNoPlans": "No subscription plans currently include personal tests.",
    "personalTestsPaywallCompareDescription": "See how each plan compares for {course}. Review pricing, included content, and features side by side.",
    "personalTestsPaywallFeature": "Access to personal tests",
    ...
    "blogs": "Blogs",
    "blogsPageSubtitle": "Inspiring articles and tips to help you become the best version of yourself.",
    "searchArticles": "Search articles...",
    "loadMoreArticles": "Load More Articles",
    "minRead": "min read",
    "noBlogsAvailable": "No articles are available right now. Check back soon.",
    ...
    "assistantSuggestion3": "What is my current subscription?",
    "assistantInputPlaceholder": "Type your message…",
    "assistantSend": "Send message",
    "assistantThinking": "Thinking…",
    "assistantRetry": "Try again",
    "assistantSendError": "I couldn't send your message right now. Please try again shortly.",
    "assistantAccessIncluded": "Included in your subscription",
    "assistantAccessLocked": "Not included in your subscription",
    "assistantAccessUnknown": "Sign in to check access",
    "assistantMinutes": "min",
    "assistantTranslationFallback": "Showing the closest available translation for this course.",
    "assistantManageSubscription": "Manage subscription",
    "assistantSubscriptionTitle": "Your subscription",
    "assistantSubscriptionPlan": "Plan",
    "assistantSubscriptionStatusLabel": "Status",
    "assistantSubscriptionRenewal": "Current period ends",
    "assistantSubscriptionCancelScheduled": "Cancellation is scheduled at the end of the current period.",
    "assistantSubscriptionNone": "No active plan",
    "assistantSubscriptionStatusActive": "Active",
    "assistantSubscriptionStatusTrialing": "Trialing",
    "assistantSubscriptionStatusPastDue": "Past due",
  ...
  ar: {
    ...
    "personalTestsPaywallTitle": "افتحي الاختبارات الشخصية",
    "personalTestsPaywallPremiumLabel": "اختبارات شخصية",
    "personalTestsPaywallSubscribeDescription": "اختاري خطة تتضمن الاختبارات الشخصية لخوض التقييمات والحصول على توصيات برامج مخصصة.",
    "personalTestsPaywallUpgradeDescription": "خطتك الحالية لا تتضمن الاختبارات الشخصية. قومي بالترقية إلى خطة تتضمنها.",
    "personalTestsPaywallNoPlans": "لا توجد خطط اشتراك تتضمن الاختبارات الشخصية حالياً.",
    "personalTestsPaywallCompareDescription": "قارني الخطط المتاحة لـ {course}. راجعي الأسعار والمحتوى المشمول والمزايا جنبًا إلى جنب.",
    "personalTestsPaywallFeature": "الوصول إلى الاختبارات الشخصية",
    "recommendedCourses": "الدورات المقترحة",
    "testCompletedTitle": "لقد أكملت الاختبار!",
    "testCompletedSubtitle": "بناءً على إجاباتك، هذه نتيجتك.",
    ...
    "blogs": "المدونة",
    "blogsPageSubtitle": "مقالات ونصائح ملهمة تساعدكِ على أن تصبحي أفضل نسخة من نفسكِ.",
    "searchArticles": "ابحثي عن المقالات...",
    "loadMoreArticles": "تحميل المزيد من المقالات",
    "minRead": "دقيقة قراءة",
    "noBlogsAvailable": "لا توجد مقالات متاحة حالياً. تفقدي لاحقاً.",
    "blogNotFound": "تعذر العثور على هذه المقالة.",
    "backToBlogs": "العودة إلى المدونة",
    "share": "مشاركة",
    "aboutTheAuthor": "عن الكاتبة",
    ...
    "assistantSuggestion3": "ما حالة اشتراكي الحالي؟",
    "assistantInputPlaceholder": "اكتبي رسالتك…",
    "assistantSend": "إرسال الرسالة",
    "assistantThinking": "جاري التفكير…",
    "assistantRetry": "حاولي مرة أخرى",
    "assistantSendError": "تعذّر إرسال رسالتك حالياً. يرجى المحاولة مرة أخرى بعد قليل.",
    "assistantAccessIncluded": "مشمولة في اشتراكك",
    "assistantAccessLocked": "غير مشمولة في اشتراكك",
    "assistantAccessUnknown": "سجّلي الدخول للتحقق من إمكانية الوصول",
    "assistantMinutes": "دقيقة",
    "assistantTranslationFallback": "يتم عرض أقرب ترجمة متاحة لهذه الدورة.",
    "assistantManageSubscription": "إدارة الاشتراك",
    "assistantSubscriptionTitle": "اشتراكك",
    "assistantSubscriptionPlan": "الخطة",
    "assistantSubscriptionStatusLabel": "الحالة",
    "assistantSubscriptionRenewal": "ينتهي الدفع الحالي",
    "assistantSubscriptionCancelScheduled": "تم جدولة الإلغاء في نهاية الفترة الحالية.",
    "assistantSubscriptionNone": "لا توجد خطة نشطة",
    "assistantSubscriptionStatusActive": "نشط",
    "assistantSubscriptionStatusTrialing": "تجريبي",
    "assistantSubscriptionStatusPastDue": "متأخر",
